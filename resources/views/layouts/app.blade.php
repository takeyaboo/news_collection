...
<head>
    ...
    <title>{{ config('app.name', 'ニュース収集') }}</title>
    ...
    <div id="app">
                        ...
                        @else
                            <!-- <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown"> -->
                                    <div><a class="btn btn-primary" href="{{ route('logout') }}"
        ...
        @if(!auth()->guest())
          <div class="text-center">
            <button type="button" class="btn btn-primary"　onclick="location.href='/home'">トップに戻る</button>
